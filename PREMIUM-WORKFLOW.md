...
**Deployment Command:**
```bash
./scripts/deploy-website.sh "project-name" "/root/clawd/projects/project-name"
# → Creates /project-name/ folder in FTP
# → Uploads all files
...
**Example:**
```bash
./scripts/deploy-website.sh "seed-to-cup-v2" "/root/clawd/projects/seed-to-cup-v2"
# Live at: https://alfred.godeliauskas.com/seed-to-cup-v2/
# Portfolio: https://alfred.godeliauskas.com/ (automatically shows new project)
```
